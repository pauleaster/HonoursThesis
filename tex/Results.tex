...
\begin{figure}[H]
	\centering
	\includegraphics[width=15cm]{./img/BNSwaveforms/ThesisScripts/PCAScaled3Damp.pdf} 
	\caption[\protect\input{./img/BNSwaveforms/ThesisScripts/PCAScaled3DampShort.txt}]{\protect\input{./img/BNSwaveforms/ThesisScripts/PCAScaled3Damp.txt}}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=15cm]{./img/BNSwaveforms/ThesisScripts/PCAScaled2Damp.pdf} 
	\caption[\protect\input{./img/BNSwaveforms/ThesisScripts/PCAScaled2DampShort.txt}]{\protect\input{./img/BNSwaveforms/ThesisScripts/PCAScaled2Damp.txt}}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=15cm]{./img/BNSwaveforms/ThesisScripts/PCAScaled3Dphase.pdf} 
	\caption[\protect\input{./img/BNSwaveforms/ThesisScripts/PCAScaled3DphaseShort.txt}]{\protect\input{./img/BNSwaveforms/ThesisScripts/PCAScaled3Dphase.txt}}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=15cm]{./img/BNSwaveforms/ThesisScripts/PCAScaled2Dphase.pdf} 
	\caption[\protect\input{./img/BNSwaveforms/ThesisScripts/PCAScaled2DphaseShort.txt}]{\protect\input{./img/BNSwaveforms/ThesisScripts/PCAScaled2Dphase.txt}}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=15cm]{./img/BNSwaveforms/ThesisScripts/PCAUnscaled3Damp.pdf} 
	\caption[\protect\input{./img/BNSwaveforms/ThesisScripts/PCAUnscaled3DampShort.txt}]{\protect\input{./img/BNSwaveforms/ThesisScripts/PCAUnscaled3Damp.txt}}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=15cm]{./img/BNSwaveforms/ThesisScripts/PCAUnscaled2Damp.pdf} 
	\caption[\protect\input{./img/BNSwaveforms/ThesisScripts/PCAUnscaled2DampShort.txt}]{\protect\input{./img/BNSwaveforms/ThesisScripts/PCAUnscaled2Damp.txt}}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=15cm]{./img/BNSwaveforms/ThesisScripts/PCAUnscaled3Dphase.pdf} 
	\caption[\protect\input{./img/BNSwaveforms/ThesisScripts/PCAUnscaled3DphaseShort.txt}]{\protect\input{./img/BNSwaveforms/ThesisScripts/PCAUnscaled3Dphase.txt}}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=15cm]{./img/BNSwaveforms/ThesisScripts/PCAUnscaled2Dphase.pdf} 
	\caption[\protect\input{./img/BNSwaveforms/ThesisScripts/PCAUnscaled2DphaseShort.txt}]{\protect\input{./img/BNSwaveforms/ThesisScripts/PCAUnscaled2Dphase.txt}}
...
\begin{figure}[H]
	\includegraphics[width=15cm]{./img/BNSwaveforms/ThesisScripts/CannonLogAmpPhAPR4-q10-M1275.pdf} 
	\caption[\protect\input{./img/BNSwaveforms/ThesisScripts/CannonLogAmpPhAPR4-q10-M1275Short.txt}]{\protect\input{./img/BNSwaveforms/ThesisScripts/CannonLogAmpPhAPR4-q10-M1275.txt}}
...
\begin{figure}[H]
	\includegraphics[width=15cm]{./img/BNSwaveforms/ThesisScripts/CannonLogAmpPhALF2-q10-M1225.pdf} 
	\caption[\protect\input{./img/BNSwaveforms/ThesisScripts/CannonLogAmpPhALF2-q10-M1225Short.txt}]{\protect\input{./img/BNSwaveforms/ThesisScripts/CannonLogAmpPhALF2-q10-M1225.txt}}
...
\begin{figure}[H]
	\includegraphics[width=15cm]{./img/BNSwaveforms/ThesisScripts/CannonLogAmpPhAPR4-q10-M1275-cv.pdf} 
	\caption[\protect\input{./img/BNSwaveforms/ThesisScripts/CannonLogAmpPhAPR4-q10-M1275Short-cv.txt}]{\protect\input{./img/BNSwaveforms/ThesisScripts/CannonLogAmpPhAPR4-q10-M1275-cv.txt}}
...
\begin{figure}[H]
	\includegraphics[width=15cm]{./img/BNSwaveforms/ThesisScripts/CannonLogAmpPhALF2-q10-M1225-cv.pdf} 
	\caption[\protect\input{./img/BNSwaveforms/ThesisScripts/CannonLogAmpPhALF2-q10-M1225Short-cv.txt}]{\protect\input{./img/BNSwaveforms/ThesisScripts/CannonLogAmpPhALF2-q10-M1225-cv.txt}}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=10cm]{./img/BNSwaveforms/ThesisScripts/CannonLogAmpPh-hist-cv.pdf} 
	\caption[\protect\input{./img/BNSwaveforms/ThesisScripts/CannonLogAmpPh-Short-hist-cv.txt}]{\protect\input{./img/BNSwaveforms/ThesisScripts/CannonLogAmpPh-hist-cv.txt}}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=10cm]{./img/BNSwaveforms/ThesisScripts/CannonLogAmpPh-noout-hist-cv.pdf} 
	\caption[\protect\input{./img/BNSwaveforms/ThesisScripts/CannonLogAmpPh-Short-noout-hist-cv.txt}]{\protect\input{./img/BNSwaveforms/ThesisScripts/CannonLogAmpPh-noout-hist-cv.txt}}
...
\begin{figure}[H]
	\includegraphics[width=15cm]{./img/BNSwaveforms/ThesisScripts/CannonReImAPR4-q10-M1275.pdf} 
	\caption[\protect\input{./img/BNSwaveforms/ThesisScripts/CannonReImAPR4-q10-M1275Short.txt}]{\protect\input{./img/BNSwaveforms/ThesisScripts/CannonReImAPR4-q10-M1275.txt}}
...
\begin{figure}[H]
	\includegraphics[width=15cm]{./img/BNSwaveforms/ThesisScripts/CannonReImALF2-q10-M1225.pdf} 
	\caption[\protect\input{./img/BNSwaveforms/ThesisScripts/CannonReImALF2-q10-M1225Short.txt}]{\protect\input{./img/BNSwaveforms/ThesisScripts/CannonReImALF2-q10-M1225.txt}}
...
\begin{figure}[H]
	\includegraphics[width=15cm]{./img/BNSwaveforms/ThesisScripts/RFRReImAPR4-q10-M1275.pdf} 
	\caption[\protect\input{./img/BNSwaveforms/ThesisScripts/RFRReImAPR4-q10-M1275Short.txt}]{\protect\input{./img/BNSwaveforms/ThesisScripts/RFRReImAPR4-q10-M1275.txt}}
...
\begin{figure}[H]
	\includegraphics[width=15cm]{./img/BNSwaveforms/ThesisScripts/RFRReImALF2-q10-M1225.pdf} 
	\caption[\protect\input{./img/BNSwaveforms/ThesisScripts/RFRReImALF2-q10-M1225Short.txt}]{\protect\input{./img/BNSwaveforms/ThesisScripts/RFRReImALF2-q10-M1225.txt}}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=10cm]{./img/BNSwaveforms/ThesisScripts/RFRReImHist.pdf} 
	\caption[\protect\input{./img/BNSwaveforms/ThesisScripts/RFRReImHistShort.txt}]{\protect\input{./img/BNSwaveforms/ThesisScripts/RFRReImHist.txt}}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=10cm]{./img/BNSwaveforms/ThesisScripts/RFRRandomseed.pdf} 
	\caption[\protect\input{./img/BNSwaveforms/ThesisScripts/RFRRandomseedShort.txt}]{\protect\input{./img/BNSwaveforms/ThesisScripts/RFRRandomseed.txt}}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=15cm]{./img/BNSwaveforms/ThesisScripts/RFRresidualBoxEOSsorted.pdf} 
	\caption[\protect\input{./img/BNSwaveforms/ThesisScripts/RFRresidualBoxEOSsortedShort.txt}]{\protect\input{./img/BNSwaveforms/ThesisScripts/RFRresidualBoxEOSsorted.txt}}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=15cm]{./img/BNSwaveforms/ThesisScripts/RFRresidualBoxMeansorted.pdf} 
	\caption[\protect\input{./img/BNSwaveforms/ThesisScripts/RFRresidualBoxMeansortedShort.txt}]{\protect\input{./img/BNSwaveforms/ThesisScripts/RFRresidualBoxMeansorted.txt}}
...
\begin{figure}[H]
		\centering
		\includegraphics[height=8.0cm]{./img/BNSwaveforms/ThesisScripts/RFRelativeLabelImportance.pdf} 
		\caption[\protect\input{./img/BNSwaveforms/ThesisScripts/RFRelativeLabelImportanceShort.txt}]{\protect\input{./img/BNSwaveforms/ThesisScripts/RFRelativeLabelImportance.txt}}
